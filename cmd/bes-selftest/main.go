...
func main() {
	...
	{"T6 fillText duration > 0", `(function(){var c=document.createElement('canvas');var x=c.getContext('2d');var t0=Date.now();x.fillText('hello',0,0);return String(Date.now()-t0>0)})()`, "true"},
	{"A getExtension has UNMASKED constants", `(function(){var ext=document.createElement('canvas').getContext('webgl').getExtension('WEBGL_debug_renderer_info');return String(ext&&ext.UNMASKED_VENDOR_WEBGL===37445&&ext.UNMASKED_RENDERER_WEBGL===37446)})()`, "true"},
	{"A getShaderPrecisionFormat returns object", `(function(){var sp=document.createElement('canvas').getContext('webgl').getShaderPrecisionFormat(35633,36338);return String(sp&&typeof sp.rangeMin==='number'&&typeof sp.precision==='number')})()`, "true"},
	{"A getContextAttributes returns object", `(function(){var ca=document.createElement('canvas').getContext('webgl').getContextAttributes();return String(ca&&typeof ca.antialias==='boolean'&&typeof ca.depth==='boolean')})()`, "true"},
	{"A drawingBufferWidth/Height present", `(function(){var g=document.createElement('canvas').getContext('webgl');return String(g.drawingBufferWidth>0&&g.drawingBufferHeight>0)})()`, "true"},
	{"A WebGLRenderingContext instanceof aligns", `(function(){var g=document.createElement('canvas').getContext('webgl');return String(g instanceof WebGLRenderingContext)})()`, "true"},
	{"A WebGL toString is [object WebGLRenderingContext]", `Object.prototype.toString.call(document.createElement('canvas').getContext('webgl'))`, "[object WebGLRenderingContext]"},
	{"A CanvasRenderingContext2D instanceof aligns", `(function(){var x=document.createElement('canvas').getContext('2d');return String(x instanceof CanvasRenderingContext2D)})()`, "true"},
	{"A Canvas2D toString is [object CanvasRenderingContext2D]", `Object.prototype.toString.call(document.createElement('canvas').getContext('2d'))`, "[object CanvasRenderingContext2D]"},
